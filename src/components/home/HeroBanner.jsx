          ...
          <SwiperSlide key={item.id}>
            ...
            >
              <div className="flex items-center w-full h-full relative">
                <div className="flex flex-col justify-center items-center w-[52%] pr-4 pl-8 sm:pl-14 space-y-3 relative z-10 text-center">
                  <div className="space-y-2 w-full max-w-[480px]">
                    <div className="relative">
                      <h3 className={`text-[15px] font-medium tracking-[0.2em] uppercase relative inline-block ${
                    ...
                    <div className="min-h-[3rem] relative group">
                      ...
                      <h1 className={`text-2xl sm:text-[28px] font-black leading-[1.1] line-clamp-2 whitespace-normal tracking-tight relative ${
                  ...
                  <p className={`text-[13px] leading-relaxed w-full max-w-[480px] line-clamp-2 font-light tracking-wide ${
                  ...
                  <div className="pt-1">
                    <Link 
                      className={`group relative inline-flex items-center px-4 py-1.5 text-[13px] font-medium rounded-lg overflow-hidden transition-all duration-300 ${
                    ...
                    >
                      <span className="relative z-10 flex items-center">
                        Khám phá ngay
                        <svg className="w-3.5 h-3.5 ml-1.5 transform transition-transform duration-300 group-hover:translate-x-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div className="absolute right-0 top-1/2 -translate-y-1/2 w-[50%] h-[135%] flex items-center justify-end pr-4">
                  <div className="relative w-full h-full flex items-center justify-center group cursor-pointer">
                    ...
                    <img 
                      ...
                      loading="lazy"
                      className="relative w-full h-full object-contain object-right transition-all duration-500 group-hover:scale-[1.03] group-hover:brightness-110"
                    />
                  </div>
                </div>
              </div>
