          ...
          >
            ...
            <div className="mt-5 sm:mt-4 sm:flex sm:flex-row-reverse">
              <button
                ...
                className="inline-flex w-full bg-customRed justify-center rounded-md bg-red-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-red-500 sm:ml-3 sm:w-auto disabled:opacity-50 disabled:cursor-not-allowed"
