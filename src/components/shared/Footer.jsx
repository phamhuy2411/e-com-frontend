...
const Footer = () => {
  return (
    <footer className="bg-gradient-to-br from-slate-900 via-blue-900 to-slate-800 text-white py-8">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {/* Quick Links */}
          <div className="h-full flex flex-col">
            <h3 className="text-xl font-bold mb-4 bg-gradient-to-r from-blue-400 via-cyan-400 to-blue-500 bg-clip-text text-transparent">Quick Links</h3>
          ...
          {/* Trade Assurance */}
          <div className="h-full flex flex-col">
            <h3 className="text-xl font-bold mb-4 bg-gradient-to-r from-blue-400 via-cyan-400 to-blue-500 bg-clip-text text-transparent">Trade Assurance</h3>
            <ul className="space-y-2">
              <li>
                <a
                  href="#"
          ...
          {/* Contact Info */}
          <div className="h-full flex flex-col">
            <h3 className="text-xl font-bold mb-4 bg-gradient-to-r from-blue-400 via-cyan-400 to-blue-500 bg-clip-text text-transparent">Contact Us</h3>
          ...
          <div className="md:col-span-3 text-center mt-8">
            <h3 className="text-2xl font-bold mb-4 bg-gradient-to-r from-blue-400 via-cyan-400 to-blue-500 bg-clip-text text-transparent">Gearvana</h3>
        ...
        {/* Copyright */}
        <div className="border-t border-blue-500/20 mt-8 pt-6 text-center text-gray-300">
          <p>
