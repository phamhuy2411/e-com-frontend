    ...
    return (
        <main className="max-w-7xl mx-auto px-4 py-8">
            <section aria-labelledby="about-heading">
                <h1 
                    id="about-heading"
                    className="text-slate-800 text-4xl font-bold text-center mb-12"
                >
                    About Us
                </h1>
            ...
            <section aria-labelledby="products-heading" className="py-7 space-y-8">
                <h2 
                    id="products-heading"
                    className="text-slate-800 text-4xl font-bold text-center"
                >
                    Our Products
                </h2>
